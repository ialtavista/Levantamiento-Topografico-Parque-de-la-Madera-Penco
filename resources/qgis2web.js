...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32718',
            //extent: [678392.562500, 5930962.500000, 678682.812500, 5932187.000000],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([677012.788810, 5930664.868610, 679762.601929, 5932558.607833], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Levantamiento Topográfico Red AS Parque de La Madera, Penco</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (330 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '28 cámaras inspeccionadas (verificación y mediciones interior cámara completadas; medición profundidad canal directa).<br />4 cámaras con nivel (sin mediciones interior cámara; medición profundidad canal indirecta).<br />10 cámaras selladas (Tapa soldada a anillo, requiere demolición).<br />11 cámaras no encontradas (No visibles en superficie)';
            }
